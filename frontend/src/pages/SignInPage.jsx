...
function FinancePanel() {
  return (
    <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
      ...
      />
      <div className="relative z-10 ml-3 hidden lg:block lg:p-12">
...
export default function SignInPage() {
  ...
  const destination = location.state?.from?.startsWith("/dashboard")
    ? location.state.from
    : "/dashboard";
        ...
        <main className="flex items-center justify-center px-6 py-12 sm:px-12 lg:col-span-7 xl:col-span-6">
          <div className="w-full max-w-md space-y-6">
            <div className="text-center lg:hidden">
              ...
              <p className="mt-3 text-gray-600">Organize your expenses, visualize your budget, and grow your savings with ease.</p>
            </div>
            <div className="rounded-lg border border-slate-200 p-6 shadow-sm sm:p-8">
              <h1 className="text-2xl font-bold text-gray-900">Sign in</h1>
              <p className="mt-1 text-sm text-gray-600">Welcome back — pick up where you left off.</p>
              ...
              <p className="mt-5 text-center text-sm text-gray-600">
                New here? <Link className="font-medium text-primary hover:underline" to="/sign-up">Create an account</Link>
              </p>
            </div>
          </div>
        </main>
